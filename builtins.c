...
/**
 * cd_b - Changes the work dir to parameter passed to cd.
 * @line: A string representing the input from the user.
 *
 * Return: if no parameter is passed it will change directory to HOME.
 */
...
/**
 * env_b - Prints all the environmental variables in current shell.
 * @line: String representing the input from the user.
 */
 ...
 * @line: String representing user input
 */
